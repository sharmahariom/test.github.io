...
function slideShow() {
  ...
  var globals = {
    ...
    fadeDelay: 44, // The time interval between individual opacity changes. This should always be much smaller than slideDelay.  
    wrapperID: "image_group_23", // The ID of the <div> element that contains all of the <img> elements to be shown as a slide show.
    ...
    wrapperObject: null, // Will contain a reference to the <div> element tha t contains all of the <img> elements to be shown as a slide show.
  ...
  function initializeSlideShowMarkup() {  
    ...
    globals.wrapperObject.style.position = "absolute";
