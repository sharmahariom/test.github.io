...
function slideShow() {
  ...
  var globals = {
    ...
    fadeDelay: 28, // The time interval between individual opacity changes. This should always be much smaller than slideDelay.  
    wrapperID: "image_group_13", // The ID of the <div> element that contains all of the <img> elements to be shown as a slide show.
